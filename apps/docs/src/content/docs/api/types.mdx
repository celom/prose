---
title: Types
description: API reference for core TypeScript types exported by Flume.
sidebar:
  order: 6
---
...
The transaction client passed to `.transaction()` step handlers. This is an opaque type — it matches whatever your ORM's transaction callback provides.
