---
title: Core Concepts
description: Understand how flows, steps, state threading, and the builder pattern work in Flume.
---
...
Flume provides several step types:
...
The core design of Flume is **type-safe state threading**. Each step's return value is shallow-merged into the accumulated state, and TypeScript tracks the types through the entire chain.
...
See the [Sub-flows guide](/flume/guides/sub-flows/) for more details.
