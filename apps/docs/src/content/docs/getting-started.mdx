...
description: Install Prose and build your first workflow in minutes.
---
...
- Learn about [Core Concepts](/prose/core-concepts/) to understand how flows, steps, and state work
- Explore [Guides](/prose/guides/retries/) for specific features like retries, timeouts, and transactions
- See the [API Reference](/prose/api/create-flow/) for detailed documentation
